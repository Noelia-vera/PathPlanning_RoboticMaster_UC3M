...
while not done:
    ...
    for node in nodes:
         print("--------------------- number of nodes: "+str(len(nodes)))
         last_node = nodes[-1]  # Obtener el último nodo de la lista
         last_node.dump()  # Puedes usar last_node para realizar acciones en el último nodo
         nodes.pop()  # Eliminar el último nodo de la lista
         explored_nodes += 1
